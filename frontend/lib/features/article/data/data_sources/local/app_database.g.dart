    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `article` (`id` TEXT NOT NULL, `author` TEXT, `title` TEXT, `description` TEXT, `url` TEXT, `urlToImage` TEXT, `publishedAt` INTEGER, `content` TEXT, PRIMARY KEY (`id`))');
    ...
    this.changeListener,
        ...
        _articleModelInsertionAdapter = InsertionAdapter(
            ...
            (ArticleModel item) => <String, Object?>{
                  ...
                  'publishedAt': item.publishedAtTimestamp,
  ...
  Stream<List<ArticleModel>> getArticles() {
    return _queryAdapter.queryListStream('SELECT * FROM article',
        mapper: (Map<String, Object?> row) => ArticleModel(
            ...
            publishedAtTimestamp: row['publishedAt'] as int?,
